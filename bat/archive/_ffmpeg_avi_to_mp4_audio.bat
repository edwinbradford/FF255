...
ffmpeg -y -i %input% -vn -metadata:s:a:0 language=eng -profile:a aac_low -ac 2 -b:a 160k mp4/aac_lc_160k.mp4
echo.

echo Encoded audio to aac_lc_160k mp4. && echo.
