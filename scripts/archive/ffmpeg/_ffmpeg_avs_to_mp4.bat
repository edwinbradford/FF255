...
echo Encoding 1080p 5000kbps see logs/h264_1080p_05000k.log
ffmpeg -i %input% -an ^
-vf "scale=-2:1080" ^
-c:v libx264 -profile:v main -level:v 4.2 ^
-x264opts scenecut=0:open_gop=0:min-keyint=%GOP%:keyint=%GOP% ^
-minrate 5000k -maxrate 5000k -bufsize 5000k -b:v 5000k ^
-y mp4/h264_1080p_05000k.mp4
echo.

echo Encoding 1080p 4000kbps see logs/h264_1080p_04000k.log
ffmpeg -i %input% -an ^
-vf "scale=-2:1080" ^
-c:v libx264 -profile:v main -level:v 4.2 ^
-x264opts scenecut=0:open_gop=0:min-keyint=%GOP%:keyint=%GOP% ^
-minrate 4000k -maxrate 4000k -bufsize 4000k -b:v 4000k ^
-y mp4/h264_1080p_04000k.mp4
echo.
